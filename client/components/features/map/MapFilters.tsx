...
export default function MapFilters({ onFilterChange, isVisible = true }: MapFiltersProps) {
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          // Use !fixed to override any potential conflicts, though wrapping separating classes is safer
          className="fixed bottom-6 left-6 z-30"
        >
          <div
            className="glass-light glass-shine rounded-2xl shadow-float overflow-hidden w-[210px] md:w-[280px]"
            style={{ padding: isExpanded ? '12px' : '8px' }}
          >
            {/* Header */}
